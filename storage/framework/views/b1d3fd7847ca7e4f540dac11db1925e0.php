...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg bg-body-tertiary mb-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>">Dev</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <?php if($worker->foto): ?>
                                    <img src="<?php echo e(asset('storage/' . $worker->foto)); ?>" alt="Foto" width="50" height="50"
                                ...
                                <td><?php echo e($worker->nombres); ?></td>
                                <td><?php echo e($worker->apellido_paterno); ?> <?php echo e($worker->apellido_materno); ?></td>
                                <td><?php echo e($worker->dni); ?></td>
                                <td>S/ <?php echo e(number_format($worker->sueldo_base, 2)); ?></td>
                                <td class="fw-bold text-primary">S/ <?php echo e(number_format($worker->sueldo_neto, 2)); ?></td>

                                <td>
                                    <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-view-<?php echo e($worker->id); ?>">
                                        Ver
                                    </button>

                                    <div class="modal fade" id="modal-view-<?php echo e($worker->id); ?>" tabindex="-1"
                                        aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-dark">
                                                    ...
                                                    <div class="text-center mb-4">
                                                        <?php if($worker->foto): ?>
                                                        <img src="<?php echo e(asset('storage/' . $worker->foto)); ?>"
                                                            alt="Foto de <?php echo e($worker->nombres); ?>"
                                                    ...
                                                    <h5 class="text-primary border-bottom pb-2 text-center">
                                                        <?php echo e($worker->nombres); ?> <?php echo e($worker->apellido_paterno); ?></h5>

                                                    <div class="row mt-3">
                                                        <div class="col-6">
                                                            <p><strong>DNI:</strong> <?php echo e($worker->dni); ?></p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p><strong>Área:</strong> <?php echo e($worker->area); ?></p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p><strong>Cargo:</strong> <?php echo e($worker->cargo); ?></p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p><strong>Hijos:</strong> <?php echo e($worker->cantidad_hijos); ?></p>
                                                        </div>
                                                    </div>

                                                    <div class="bg-light p-3 mt-2 rounded border">
                                                        <p class="mb-1"><strong>Sueldo Base:</strong> S/
                                                            <?php echo e(number_format($worker->sueldo_base, 2)); ?></p>
                                                        <p class="mb-1"><strong>Asignación Familiar:</strong> S/
                                                            <?php echo e(number_format($worker->asignacion_familiar, 2)); ?></p>
                                                        
                                                        <p class="mb-1"><strong>AFP:</strong> S/
                                                            <?php echo e(number_format($worker->descuento_afp_obligatoria + $worker->descuento_afp_comision, 2)); ?></p>

                                                        <P Class="mb-1"><strong>Renta:</strong> S/
                                                            <?php echo e(number_format($worker->descuento_renta_5ta, 2)); ?></P>

                                                        <p class="mb-1"><strong>EPS:</strong> S/
                                                            <?php echo e(number_format($worker->descuento_eps, 2)); ?></p>    
                                                        
                                                        <p class="mb-1 text-danger"><strong>Descuentos (AFP, Renta,
                                                                EPS):</strong> - S/
                                                            <?php echo e(number_format($worker->sueldo_bruto - $worker->sueldo_neto, 2)); ?>

                                                        </p>
                                                        <hr>
                                                        <h4 class="text-success mt-2 mb-0 text-center"><strong>Neto a
                                                                Pagar: S/
                                                                <?php echo e(number_format($worker->sueldo_neto, 2)); ?></strong>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="modal-add-worker" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('trabajadors.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\OVERLAP36\Desktop\Nuevacarpeta\VISUALCODE\calculadora-sueldo-neto\resources\views/home.blade.php ENDPATH**/ ?>